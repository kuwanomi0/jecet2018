...
private:
    ...
    Course lCourse[10] =  {
        {     1,   0,  0,  0,     110,  0, 96, 0.0300F, 0.0000F, 1.0000F, 1.00F, 1 },  //  S
    ...
    Course rCourse[12] =  {
        {     1,   0,  0,  0,     110,  0, 96, 0.0300F, 0.0000F, 1.0000F, 1.00F, 1 },  //  S
        {    10,   0,  0,  0,     100,  0,100, 0.0700F, 0.0000F, 1.0000F, 1.00F, 1 },  //  S   startdash
        {  1950,   0,  0,  0,     155,  0, 55, 0.0500F, 0.0000F, 1.0000F, 1.00F, 1 },  //  1 直進
        {  3800,   0,  0,  0,     120,  0,  5, 0.0920F, 0.0001F, 1.0000F, 1.20F, 1 },  //  2 左カーブ
        {  4200,   0,  0,  0,     140,  0,  5, 0.0500F, 0.0000F, 1.0000F, 1.10F, 1 },  //  3 直進
        {  4900,   0,  0,  0,     120,  0,  5, 0.0920F, 0.0000F, 1.0000F, 1.40F, 1 },  //  4 左カーブ
        {  5600,   0,  0,  0,     120,  0,  5, 0.0920F, 0.0000F, 1.1000F, 0.93F, 1 },  //  5 右カーブ
        {  6200,   0,  0,  0,     140,  0,  5, 0.0500F, 0.0000F, 1.1000F, 1.00F, 1 },  //  6 直進
        {  7360,   0,  0,  0,     115,  0,  5, 0.0970F, 0.0001F, 1.1000F, 0.93F, 1 },  //  7 右カーブ
        {  9800,   0,  0,  0,     155,  0,  5, 0.0500F, 0.0000F, 1.0000F, 1.00F, 1 },  //  8 直進
        { 12000,   0,  0,  0,      80,  0,  5, 0.0900F, 0.0001F, 0.8000F, 1.50F, 1 },  //  8G 左カーブ及び灰色
