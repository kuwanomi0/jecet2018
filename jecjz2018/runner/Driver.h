...
private:
    ...
    /*  {  距離,時間,衝撃,障害,  前進,旋回,尻尾,Gyro  P   ,    I   ,    D  ,目標RGB,走行法} */
        ...
        { 99999,    0,  0,  0,     100,  0,  5,   0, 0.1000F, 0.0000F, 1.2000F, 1.00F, 1 },  //  3 直線
    };
    Course lCourse[24] =  {
        {     1,    0,  0,  0,     150,  0, 95,   0, 0.0300F, 0.0000F, 1.0000F, 1.00F, 1 },  //  1 初期化配列
        {     0,  150,  0,  0,     115,  0, 96,   0, 0.0300F, 0.0000F, 1.0000F, 1.00F, 1 },  //  2 S
        ...
        {   700,    0,  0,  0,     110,  0,  5,   0, 0.0920F, 0.0001F, 1.5000F, 0.85F, 1 },  //  6 右カーブ
        {   550,    0,  0,  0,     130,  0,  5,   0, 0.0500F, 0.0000F, 1.2000F, 0.85F, 1 },  //  7 直線
        {   800,    0,  0,  0,     110,  0,  5,   0, 0.0920F, 0.0001F, 1.5000F, 0.85F, 1 },  //  8 右カーブ
        ...
        {   440,    0,  0,  0,      10,  0, 63,   0, 0.0700F, 0.0002F, 0.4000F, 0.98F, 0 },  // 19 ダブル通過(PID ON)
        /* ここからガレージ */
        {    10,    0,  0,  0,     -70,  0, 81,   0, 0.0000F, 0.0000F, 0.0000F, 1.00F, 0 },  // 20 走行体角度上げ
        {   280,    0,  0,  0,      10,  0, 81,   0, 0.0000F, 0.0000F, 0.0000F, 1.00F, 0 },  // 21 灰色通過
        {   235,    0,  0,  0,      10,  0, 81,   0, 0.0000F, 0.0000F, 0.0000F, 1.00F, 0 },  // 22 ガレージ
    ...
    Course rCourse[21] =  {
        ...
        {  1850,    0,  0,  0,     120,  0,  5,   0, 0.0920F, 0.0001F, 1.2000F, 1.15F, 1 },  //  4 左カーブ
        ...
        {   200, 2000,  0,  0,     -50,  0,  5, -10, 0.0000F, 0.0000F, 0.0000F, 1.00F, 1 },  // 16 シーソ切り替わり
        {   180,    0,  0,  0,      30,  0, 60,   5, 0.0000F, 0.0000F, 0.0000F, 1.00F, 1 },  // 17 シーソ降下
        /* ここから着地後動作 */
        {     0,  200,  0,  0,      80,  0, 80, -20, 0.0000F, 0.0000F, 0.0000F, 1.00F, 0 },  // 18 尻尾倒立処理
        {   200,    0,  0,  0,      10,  0, 80, -20, 0.0000F, 0.0000F, 0.0000F, 1.00F, 0 },  // 19 少し前進
