...
private:
    ...
    /*  {  距離,時間,衝撃,障害,  前進,旋回,尻尾,Gyro  P   ,    I   ,    D  ,目標RGB,走行法} */
        {     1,    0,  0,  0,      80,  0, 95,   0, 0.0300F, 0.0000F, 1.0000F, 1.00F, 1 },  //  初期化配列
        {     0,  150,  0,  0,      80,  0, 96,   0, 0.0300F, 0.0000F, 1.0000F, 1.00F, 1 },  //  S
        { 92200,    0,  0,  0,      80,  0, 75,   0, 0.0900F, 0.0001F, 0.8000F, 1.50F, 1 },
        {     0,    0,  0,  0,       0,  0, 80,   0, 0.0000F, 0.0000F, 0.0000F, 1.00F, 0 }
    };
    Course lCourse[23] =  {
        ...
        {  1800,    0,  0,  0,     116,  0,  5,   0, 0.0500F, 0.0000F, 1.0000F, 1.00F, 1 },  //  3 直線
        ...
        {  2400,    0,  0,  0,     118,  0,  5,   0, 0.0500F, 0.0000F, 1.0000F, 1.00F, 1 },  //  7 直進
        /* ここからルックアップ */
        ...
        {     0,  250,  0,  0,     -13,  0, 81,   0, 0.0000F, 0.0000F, 0.0000F, 1.00F, 0 },  //  走行体角度上げ
